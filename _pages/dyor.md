...
**OctoFi gives you cash back** when you transact with the most trusted decentralized finance (DeFi) and non-fungible token (NFT) marketplaces. Earn free crypto. <span class="text-span">Octomatically</span>. 

Our cashback mechanism is built into: 

- **<span class="text-span">OctoFi Wallet:</span>** a fork of MetaMask with lower built-in swap fees, support for various networks by default, essential NFT features, and removal of all user tracking.
- **<span class="text-span">OctoFi Platform:</span>** an all-in-one decentralized application serving up direct access to a broad range of DeFi and NFT marketplaces from one convenient location.

## 🤔 How does it work?

When you transact with any of our <span class="text-span">referral partners</span> using our wallet, either from our platform, or directly on their own websites:

- They pay us a share of their revenue as commission
- We pass through <span class="text-span">40% to you (if using our wallet)</span>
- The remaining <span class="text-span">60% goes to our token holders</span>

If you don't have our wallet installed, you can still connect to and use our platform with most other popular wallets, but 100% of any commissions generated by your transactions will be directed to our token holders.
...
> Lolli.com <span class="text-span">for traders</span> anyone?
...
We endeavour to accelerate growth for our referral partners while embracing a chain agnostic future, so it's fair to say every effort is being made to expand [<span class="text-span">our partner network</span>](/partners) to ensure our products are useful NOW, and well into the future...

- **Wallet:** simply install it and reap the rewards when using it on our platform or one of our partner sites (eg. Get 1% cashback when you purchase any NFT on OpenSea).
- **Platform:** bookmark or install as a progressive web app (PWA) even if you prefer to use another wallet (eg. We direct 2.5% cashback from OpenSea to token holders).
- **Token:** purchase the OCTO token to gain access to exclusive features, participate in governance, and earn your share of all revenue from the wallet and platform.

As interoperability and composability shape up to be defining narratives within our industry, many leading projects are supercharging their growth by embracing the affiliate model to establish partner programs -- ecommerce giants like Amazon certainly did; so why wouldn't the <span class="text-span">future blue chips of blockchain?</span>

## 🧐 Who's behind it?

OctoFi's founding team comprising '[Dr. Octavius](https://t.me/OctoFi_Biz)' and '[Mr. OG](https://t.me/OctoFi_Dev)' have chosen to remain anonymous and have [a number of reasons](/blog/reasons-to-stay-anon-defi-team) for doing so. While their reasoning pertains mostly to decentralization, they've also insisted that "you don't need a team to trust, you need to [<span class="text-span">verify their work</span>](https://den.octo.fi/t/transparency)." OctoFi exists because of eight guiding principles. Without them we lose sight of the cypherpunk ethos that birthed a grassroots movement in pursuit of decentralization. We are witnessing the change we all set out to make.
...
Below you'll find all the necessary specifics to Do Your Octo Research \#DYOR. 

### Wallet ([<span class="text-span">octo.fi/download</span>](/download))

[Download our wallet now](/download) and start getting 1% cashback when you purchase NFTs on OpenSea. 

{% include section-author.html %}

Visit our [referral partners page](/partners) for an up to date list of integrations.

### Platform ([<span class="text-span">app.octo.fi</span>](https://app.octo.fi))

OctoFi's core value proposition is giving you cash back when you transact with the most trusted marketplaces in DeFi, NFT, and beyond. Our platform is our flagship product and provides a user friendly entry point for newcomers to get familiar with crypto.
...
Revenue is derived from native platform fees, partner referral commissions, and project capital deployments. Please note fee structure is incomplete and subject to change. Refer to [OIP-17](https://den.octo.fi/d/162-oip-17-platform-fees-distribution) for more information.

### OCTO token (0x7240...2ba3)
...
You can visit [hodl.octo.fi](https://hodl.octo.fi) for an up to date list of eligible addresses. Payouts are made on the 8th of each month.
...
That's it, you made it. That's how you Do Your Octo Research \#DYOR 

Now follow us on [Twitter](https://twitter.com/octofinance) and join our Telegram group [@OctoFi](https://t.me/OctoFi) to discuss the project in more detail.

Thanks frentacle, welcome to the tentacult.
